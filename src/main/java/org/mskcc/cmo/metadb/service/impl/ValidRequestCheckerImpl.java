...
public class ValidRequestCheckerImpl implements ValidRequestChecker {
    ...
    public String checkIfValidRequest(String requestJson) throws IOException {
        ...
        for (Object sample: sampleList) {
            ...
            if(!igoCmoRequestFilter && !isCmoRequest) {
                if (checkIfValidNonCmoSample(sampleMap)) {
                    validSampleList.add(sample);
                }
            } else {
                if (checkIfValidCmoSample(sampleMap)) {
                    validSampleList.add(sample);
                }
            }
     ...
     */
    boolean checkIfValidCmoSample(Map<String, String> sampleMap) {
     ...
     */
    boolean checkIfValidNonCmoSample(Map<String, String> sampleMap) {
        if(sampleMap.isEmpty() || sampleMap == null) {
            return false;
        }
        if (!hasBaitSet(sampleMap) || !hasCmoPatientId(sampleMap)) {
            return false;
        }
        return true;
    }
    
    boolean isCmoRequest(Map<String, Object> requestJsonMap) {
    ...
    boolean hasRequestId(Map<String, Object> requestJsonMap) {
    ...
    boolean hasBaitSet(Map<String, String> sampleMap) {
    ...
    boolean hasInvestigatorSampleId(Map<String, String> sampleMap) {
    ...
    boolean hasCmoPatientId(Map<String, String> sampleMap) {
     ...
     * @return
     */
    boolean hasSpecimenType(Map<String, String> sampleMap) {
    ...
    boolean hasCmoSampleClass(Map<String, String> sampleMap) {
    ...
    boolean hasSampleOrigin(Map<String, String> sampleMap) {
     ...
     * @return
     */
    boolean hasSampleType(Map<String, String> sampleMap) {
    ...
    boolean hasRecipe(Map<String, String> sampleMap) {
     ...
     * @return
     */
    boolean hasNAtoExtract(Map<String, String> sampleMap) {
     ...
     * @return
     */
    boolean hasNormalizedPatientId(Map<String, String> sampleMap) {
